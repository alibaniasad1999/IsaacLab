...
\begin{frame}{Approach 2 --- With robot}
  ...
  \begin{center}\footnotesize
  End nodes \textbf{pinned} to the gripper poses each frame $\Rightarrow$ the cable
  follows the arms cleanly, but the rod \textbf{exerts no force back} (one-way coupling).
  \end{center}
\end{frame}
...
\begin{frame}{Comparison}
  ...
  \begin{tabular}{lccc}
    ...
    Robot integration   & Two-way (force)     & One-way (kinematic)         & Two-way (rough) \\
...
\begin{frame}{Pros and cons}
  ...
  \begin{itemize}\itemsep1pt
    \item[\textcolor{green!50!black}{+}] Most faithful cable: thin, inextensible, no jelly; exact, penetration-free collision; GPU-fast.
    \item[\textcolor{red!70!black}{--}] \textbf{One-way} robot coupling (no reaction force on the arm); custom Warp code (not a native Isaac body); no volumetric contact.
  \end{itemize}
