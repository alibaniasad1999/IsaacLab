...
\begin{frame}{Approach 2 --- With robot}
  ...
  \begin{center}\footnotesize
  End nodes \textbf{spring-coupled} to the grippers (two-way). It follows the arms,
  but under a hard pull the spring gives $\Rightarrow$ it \textbf{stretches} and drags
  the follower only a little ($\sim$3\,cm).
  \end{center}
\end{frame}
...
\begin{frame}{Comparison}
  ...
  \begin{tabular}{lccc}
    ...
    Force transmission  & \textbf{Strong} ($\sim$17\,cm) & Weak (stretches)   & Weak (stretches) \\
