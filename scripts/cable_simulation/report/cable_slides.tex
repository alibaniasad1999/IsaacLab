...
\begin{itemize}
    ...
    \item Twist DOF free (no twist spring)
\end{itemize}
\vspace{0.3cm}
\textbf{Implicit PhysX TGS solver:}\\
stable across the rubber-to-rigid range\\
at $\Delta t = 1/240$ s.
\end{column}
...
\begin{tikzpicture}[
    ...
    \node[phase, fill=highlight!20] (p1) at (0,4.0)
        {\textbf{Phase 1} (done): Capsule-chain (base) model};
