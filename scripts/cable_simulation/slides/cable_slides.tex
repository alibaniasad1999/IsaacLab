...
\begin{frame}{Approach 1 --- Capsule chain (D6 joints)}
  \begin{columns}[c]
    ...
    \column{0.54\textwidth}
      \simframe{slides_output/capsule/cable_only/frame.png}{Video: capsule/cable\_only/video.mp4 (shared folder)}
  \end{columns}
\end{frame}

% ---------- 5. Approach 1 -- robot ----------
\begin{frame}{Approach 1 --- With robot}
  \simframe{slides_output/capsule/robot/frame.png}{Video: capsule/robot/video.mp4 (shared folder)}
  \begin{center}\footnotesize
...
\begin{frame}{Approach 2 --- Cosserat rod in NVIDIA Warp}
  \begin{columns}[c]
    \column{0.46\textwidth}
      ...
      \end{itemize}
    \column{0.54\textwidth}
      \simframe{slides_output/cosserat_warp/cable_only/frame.png}{Video: cosserat\_warp/cable\_only/video.mp4 (shared folder)}
  \end{columns}
\end{frame}

% ---------- 7. Approach 2 -- robot ----------
\begin{frame}{Approach 2 --- With robot}
  \simframe{slides_output/cosserat_warp/robot/frame.png}{Video: cosserat\_warp/robot/video.mp4 (shared folder)}
  \begin{center}\footnotesize
...
\begin{frame}{Approach 3 --- FEM deformable (Isaac Sim)}
  \begin{columns}[c]
    \column{0.46\textwidth}
      ...
      \end{itemize}
    \column{0.54\textwidth}
      \simframe{slides_output/fem/cable_only/frame.png}{Video: fem/cable\_only/video.mp4 (shared folder)}
  \end{columns}
\end{frame}

% ---------- 9. Approach 3 -- robot ----------
\begin{frame}{Approach 3 --- With robot}
  \simframe{slides_output/fem/robot/frame.png}{Video: fem/robot/video.mp4 (shared folder)}
  \begin{center}\footnotesize
